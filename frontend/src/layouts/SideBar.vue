<template>
  <nav class="sidebar sticky w-[300px] shrink-0 !bg-white/[0.48] !border !border-white/40 rounded-3xl px-[18px] py-[14px] overflow-hidden !shadow-none z-[1100] mr-0 will-change-[opacity,transform]" :class="{ 'entering': enterReady }" aria-label="目录">
    ...
    <div class="about-me mb-3 flex flex-col items-center max-[1000px]:items-stretch max-[1000px]:gap-3 max-[1000px]:mb-0">
      <div class="max-[1000px]:grid max-[1000px]:grid-cols-[112px_minmax(0,1fr)] max-[1000px]:items-start max-[1000px]:gap-4">
      ...
      <div class="about-content px-2 w-full m-0 text-left flex-1 min-w-0 max-[1000px]:px-0 max-[1000px]:pt-1">
            <h3 class="name text-[28px] font-bold !text-[#3b4cb8] mt-2 mb-1.5">dieWehmut</h3>
              <p class="bio text-[13px] !text-[#3b4cb8]/70 leading-[1.45] mb-3">{{ t('sidebar.bio') }}</p>

          <!-- Contact / GitHub block -->
          <div class="contact mt-2.5 flex flex-col gap-2 items-start w-full">
            <a class="github-btn inline-flex items-center justify-center gap-1.5 bg-white/[0.48] border border-white/40 text-[#3b4cb8] px-3.5 py-2 rounded-xl no-underline font-semibold text-[15px] backdrop-blur-sm shadow-[0_8px_30px_rgba(180,160,220,0.14)] w-full box-border transition-all duration-100 hover:bg-[#7c3aed]/8 hover:border-[#7c3aed]/22 hover:text-[#7c3aed]" href="https://github.com/dieWehmut" target="_blank" rel="noopener noreferrer">
              <!-- GitHub icon (simple) -->
      ...
      <div class="mobile-meta hidden flex-col gap-1.5 text-[13px] !text-[#3b4cb8]/70 items-start pl-0 max-[1000px]:flex">

...
check(
  ...
  ['pink', 'silver', 'green', 'blue', 'purple', 'yellow', 'orange', 'rose', 'cyan', 'midnight', 'grayscale', 'whiten']
    .every((form) => {
...
check('icon rejects extra segments', registry.resolveConsoleCommand(command(['icon', 'pink', 'extra'])).kind === 'silent')

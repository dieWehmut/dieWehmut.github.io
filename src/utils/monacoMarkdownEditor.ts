...
function defineThemes(monaco: MonacoModule) {
  ...
  monaco.editor.defineTheme(MONACO_THEME_DARK, {
    ...
    colors: {
      ...
      'scrollbarSlider.background': '#9b3dff66',
      'scrollbarSlider.hoverBackground': '#9b3dff99',
      'scrollbarSlider.activeBackground': '#9b3dffcc',
      'minimapSlider.background': '#9b3dff33',
      'minimapSlider.hoverBackground': '#9b3dff55',
      'minimapSlider.activeBackground': '#9b3dff77',
    },
  })
  ...
  monaco.editor.defineTheme(MONACO_THEME_LIGHT, {
    ...
    colors: {
      ...
      'scrollbarSlider.background': '#8f35ff66',
      'scrollbarSlider.hoverBackground': '#8f35ff99',
      'scrollbarSlider.activeBackground': '#8f35ffcc',
      'minimapSlider.background': '#8f35ff33',
      'minimapSlider.hoverBackground': '#8f35ff55',
      'minimapSlider.activeBackground': '#8f35ff77',
    },
  })
}
